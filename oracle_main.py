...
st.set_page_config(
    page_title="Oracle Chat Pro - Your Personal Assistant",
    page_icon="app/oracle_logo.png",
    layout="wide",
...
st.markdown("""
    ...
    <h1 style="color: #ff4b4b; font-size: 3rem; margin-bottom: 0.5rem;"> 🛢️Oracle Chat Pro </h1>
...
with st.sidebar:
    ...
    st.markdown("Upload any specific oracle document(s)")
    ...
    if uploaded_files:
        ...
        if st.button("🚀 Process Documents", type="primary"):
            with st.spinner("Processing your uploaded documents..."):
                ...
                chat_model = get_chat_model(EURON_API_KEY)
...
# Chat input
if prompt := st.chat_input("Ask anything about oracle ..."):
    ...
    if st.session_state.vectorstore and st.session_state.chat_model:
        with st.chat_message("assistant"):
            with st.spinner("🔍 Searching documents..."):
                ...
                system_prompt = f"""You are OracleChat Pro, an intelligent personal chat assistant. 
                Based on the oracle document(s) uploaded, provide accurate and helpful answers. 
...
<div style="text-align: center; color: #666; font-size: 0.9rem;">
    <p>🤖 Powered by AI & LangChain |🛢️Oracle Document Intelligence</p>
</div>
""", unsafe_allow_html=True)  
